/*
10. Correct a bug
You are working on an e-commderce website where customers can add items to their cart. The cart stores the
...
half. As a result, you need to write a JavaScript function that can double thd quantity of each item in the cart
